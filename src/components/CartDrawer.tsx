          ...
          <div class="flex-1 overflow-y-auto p-4">
            {cart.length === 0 ? (
              <div class="text-center py-12">
                <span class="text-4xl block mb-4">≡ƒÅô</span>
                  ...
                  <div key={item.priceId} class="flex gap-4 bg-surface-warm border border-border-light rounded-xl p-3">
                    ...
                    <div class="w-20 h-20 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                      {item.image ? (
                        ...
                        <div class="w-full h-full flex items-center justify-center text-2xl">≡ƒÅô</div>
                      )}
                    </div>
            ...
            <div class="border-t border-border-light p-4 space-y-3">
              {error && (
                <div class="bg-amber-50 border border-amber-200 text-amber-800 text-sm rounded-lg px-3 py-2.5 flex items-start gap-2">
                  <span class="flex-shrink-0 mt-0.5">ΓÜá∩╕Å</span>
                  <span>{error}</span>
                </div>
              )}
              ...
              {!appliedPromo ? (
                ...
                <div class="flex items-center justify-between bg-green-50 border border-green-200 rounded-lg px-3 py-2">
                  <div class="flex items-center gap-2">
                    <span class="text-green-600 text-sm">Γ£ô</span>
